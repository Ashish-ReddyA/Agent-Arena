...
type ExperimentMode = "empty" | "freethought" | "colony" | "rivalry" | "cooperation" | "oneworld" | "twopowers" | "island" | "hermit" | "finite" | "workshop" | "mutes";
...
export default function Home() {
  ...
  const bareWorld = ["island", "hermit", "finite", "workshop", "mutes"].includes(experimentMode);
